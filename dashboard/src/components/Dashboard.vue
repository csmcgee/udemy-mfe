<!-- TODO: Fix styling for prime faces upgrade -->
<template>
  <div class="grid fluid dashboard">
    <div class="col-12 lg:col-4 flex-grow-1">
    ...
    <div class="col-12 md:col-6 xl:col-3 flex-grow-1">
    ...
    <!-- <div class="col-12 lg:col-3 contacts">
